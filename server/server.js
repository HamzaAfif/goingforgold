...
io.on('connection', (socket) => {
                ...
                if (user) {
                    ...
                    for(var i = 0; i < games.games.length; i++){
                        //If the pin is equal to one of the game's pin
                            ...
                            totalPlayerPerc = Math.floor(playerCounter * 0.3); 
    ...
    socket.on('nextQuestion', function(){
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////
        if(game.gameData.question === 3 && !tenPassed || game.gameData.question === 6 && !twentyPassed || game.gameData.question === 9 && !thirtyPassed){
            ...
            if(game.gameData.question === 3){tenPassed = true;}
            if(game.gameData.question === 6){twentyPassed = true;}
            if(game.gameData.question === 9){thirtyPassed = true;}
        ...
        }else if(game.gameData.question === 10 && !finalRoundhere){

            if(game.gameData.question === 10){finalRoundhere = true;}
