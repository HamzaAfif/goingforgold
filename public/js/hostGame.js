...
socket.on('GameOver', function(data){
    ...
    document.getElementById('question').innerHTML = "The GAME is OVER !";
    ...
    document.getElementById('winnerTitle').innerHTML ="Congratulations to our brilliant Going for Gold champions!  🏆 Gold, silver, and bronze winners, you've truly aced it! "
